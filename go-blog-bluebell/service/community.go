...
func (s *CommunitySrv) GetCommunityDetailList(ctx context.Context, cid int64) (*models.Community, error) {
	communityDao := mysql.NewCommunityDao(ctx)
	communityList, err := communityDao.GetCommunityDetailList(cid)
	if err != nil {
